...
//                                                + oldFile.substring(filePrex.length());
	    ...
	    public static void main(String[] arg) {   
	        ...
	        System.out.println("输入的图片大小：" + mypic.getPicSize("D:/Documents/Pictures/image-1.jpg")/1024 + "KB");   
	        int count = 0; // 记录全部图片压缩所用时间  
	        for (int i = 0; i < 1; i++) {   
	            int start = (int) System.currentTimeMillis();   // 开始时间   
	            mypic.compressPic("D:/Documents/Pictures/", "D:/Documents/Pictures/", "image-1.jpg", "compress_min.jpg", 150, 150, false);   
	            int end = (int) System.currentTimeMillis(); // 结束时间   
	            int re = end-start; // 但图片生成处理时间   
	            count += re; System.out.println("第" + (i+1) + "张图片压缩处理使用了: " + re + "毫秒");   
	            System.out.println("输出的图片大小：" + mypic.getPicSize("D:/Documents/Pictures/compress_min.jpg")/1024 + "KB");   
	        }  
	        System.out.println("总共用了：" + count + "毫秒");  
	        
	        
	        CompressPicUtil.reduceImg("D:/Documents/Pictures/image-1.jpg","D:/Documents/Pictures/compress_min2.jpg",150,150,false);
	    }   
	 }  
