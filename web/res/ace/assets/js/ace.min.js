...
ace.general_things = function(a) {
	...
	$("#sidebar-shortcuts-large").find("button").click(function(){
		var d=$(this).attr("name");
		var c=a(document.body);c.removeClass("skin-1 skin-2 skin-3");
		if(d!="default"){c.addClass(d)}if(d=="skin-1"){
