...
<td class="bl"/><td class="b"/><td class="br"/> \
		...
		$("#fbmodal").find('.b:first, .bl, .br, .tl, .tr').each(
				function() {
		...
		$("#fbmodal .content")
				.append(
						'<div class="loading"><img src="./res/logonJS/images/loading.gif"/></div>');
		...
		$("body").append(
				'<div id="fbmodal_overlay" class="fbmodal_hide"></div>');
		$("#fbmodal_overlay").addClass("fbmodal_overlay").fadeTo(0,
				options.opacity);
		fbWidth();
