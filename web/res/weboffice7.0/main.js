...
/****************************************************
*
*	设置weboffice自带工具栏“打印预览”显示或隐藏
*
/****************************************************/
function bToolBar_vPrintView_onclick() {
	try{
		var webObj=document.getElementById("WebOffice1");
		var vCurItem = document.all.WebOffice1.HideMenuItem(0);
		//根据vCurItem判断当前按钮是否显示
		if(vCurItem & 0x20){
			webObj.HideMenuItem(0x20); //Show it
		}else{
...
/****************************************************
*
*	设置weboffice自带工具栏“打印”显示或隐藏
*
/****************************************************/
function bToolBar_vPrint_onclick() {
	try{
		var webObj=document.getElementById("WebOffice1");
		var vCurItem = document.all.WebOffice1.HideMenuItem(0);
		//根据vCurItem判断当前按钮是否显示
		if(vCurItem & 0x10){
			webObj.HideMenuItem(0x10); //Show it
		}else{
